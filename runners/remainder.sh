...
time python3 test_local_graphs.py np=45 ntpp=1 k=all py_iso=true repercent=10 nepercent=100 num_runs=4 hash_endpoints=true g=mysql_calls

time python3 test_local_graphs.py np=45 ntpp=1 k=all py_iso=true repercent=10 nepercent=100 num_runs=6 hash_endpoints=true g=citeseer
